...
def main():
    ...
    parser_main_pipeline.add_argument('--temp', type=str, help='path of the temporary directory')
    ...
    parser_main_pipeline.add_argument('--cpus', type=int, help='number of cpus to use', default=1)
    parser_main_pipeline.add_argument('--ram', type=int, help='amount of ram to use in GB', default=4)
    ...
    parser_main_pipeline.add_argument('--phenotype_folder', type=str, help='folder path to create phenotype file')
