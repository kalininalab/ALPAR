...
rule combined_ml:
    ...
    output:
        ...
        fia_strategy = TEMP_DIR / "ml" / "{antibiotic}" / "seed_{random_seed}_testsize_{test_size}_resampling_{resampling_strategy}_{model_type}_FIA_{feature_importance_analysis_strategy}.txt",
    benchmark: BENCHMARKS_DIR / "combined_ml.tsv",
    log: LOGS_DIR / "ml" / "combined_ml.log",
    params:
